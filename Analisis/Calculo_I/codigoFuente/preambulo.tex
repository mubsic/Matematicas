...
\newtheorem{ejem}{{\large\textbf{EJEMPLO}}}[chapter]%entorno para ejemplos
...
\newtheorem{col.}{\large\textbf{COROLARIO}}[chapter]
\newtheorem{ej}{\large\textbf{EJERCICIO}}[chapter]
\newtheorem{prop}{\large\textbf{PROPIEDADES}}[chapter]
\newtheorem{lema}{\large\textbf{LEMA}}[chapter]
